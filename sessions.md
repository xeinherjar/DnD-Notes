...
2 goblins did not see them.  Sir Bucket was able to sleep the wolf and two
...
Hood wondered around the inn drinking, Drupie was buying shots and egging him on,
...
stuff.  Comply or death.  Slurs moved across everyone's tongues until the only
...
companions. Drupie decided he liked their `studded leather armor`, so he took
...
crevasse was made with a man named `Glasstaff`.
...
# Session 4
After defeating the bugbears the party noticed a small goblin hiding in the
corner.  Before they could kill it, it introduced itself as `Droop` and offered
information in exchange for its life.  Flint wanted to kill it, but the others
talked him into just tying him up and using him as bait.

From the restrained bugbear they learned that `Glasstaff` was in the buidling and
that he runs the `Redbrands`, but he works for `The Spider`.  With nothing more
to learn Hood executes the bugbear and they search their bodies.  They find some
treasure and a key.

The party returned their attention to `Droop`, with the promise to point out
traps as they go, Flint puts him on a lead rope and they force him to walk in
front and enter all doors first.

In what appears to be a wizards workshop they find that someone was trying to
make invisibility potions, but they had not yet succeeded.  A rat watched them
move across the room, Sir Bucket decided the rat would make a good pet, so he
put him in his pocket.

`Glasstaff's` room was attached, he was nowhere to be found, however they did find
some treasure and a note from `The Spider` addressed to `Lord Albrek`, `Sildar`
will want to know about this.

In the armory the party restocks on arrows and dons the redcloaks hanging on the
wall, as the party continued they entered a small crypt with three sarcophagus,
each in searched.  When the party attempts to enter the next room the skeletons
rise and attack.  They party was able to easily defeat them, however the rat
died as Sir Bucket used it to deflect a hit.

### Notes
Learned about `Lightbringer` from a drawvish book
- Killed three skeletons
- Loot
  - 3x signet rings (50gp)
  - 75 cp, 55 sp, 22 ep, 15 gp
  - gold earring set with a tiny ruby (30 gp).
  - reagents: mercury, dragon bile, and powdered nightshade. 25 gp each to an apothecary or alchemist.
  - from mosk: 33sp, precious stone (50gp)
  - Iarno's chest
    - 180 sp, 130 gp,
    - 5x carnelians (10 gp each)
    - 2x peridots (15 gp each)
    - pearl (100 gp)

# Session 5
In the cells they free the three captives, in return `Mirna` tells them of her
families heirloom hidden the told old Alchemy shop in `Thundertree`.

With one room left Hood kicks the door down to finish off any remaining
`Redbrands`.  While successful, Flint suffered a critical blow and fell
unconscious.  He was brought back by Dilford.

After leaving the hideout the party had a long discussion about what to do with
`Droop`, it was decided they would set him free over Flint's objections.  In
return `Droop` suggest they locate goblin ambush sites to see if they would know
where `Cragmaw` castle lies.

The party headed back to town to rest and split their treasure.

### Notes
- Learned of `Mirna's Heirloom` quest
- Reached level 3
- Loot
  - 2x garnets (10 gp each)
  - 12 gp, 28 sp, 15 ep
- Drewpie resized his found armor
